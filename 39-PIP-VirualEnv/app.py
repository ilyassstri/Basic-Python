...
# cara masuk ke dalam virtual environment di python menggunakan printah masuk ke dalam foldernya lalu ketikkan source venv/bin/activate
# cara keluar dari virtual environment ketikkan : deactivate
# cara cek virtual environment ketikkan : virtualenv --version
